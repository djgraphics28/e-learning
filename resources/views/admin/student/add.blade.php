...
<div class="form-group">
    <a href="{{ url('/admin/student') }}" class="btn btn-custom btn-outline-success"><i class="fa fa-arrow-circle-left"></i> <b>BACK</b></a>
</div>
    ...
    $(document).ready(function() {
        $('#addForm').on('submit', function(e) {
            ...
            $.confirm({
                ...
                theme: 'light',
                title: 'Add',
                content: 'This student will be added, continue?',
                buttons: {
                    No: function () {
                    ...
                    Yes: {
                        ...
                        action: function(){
                            $.ajax({
                                url: '{{ url("admin/student/add/save") }}',
                                method: 'post',
                                data: fd,
                                processData:false,
                                contentType: false,
                                success: function(result){
                                    if (result  == 'success') {
                                        ...
                                        $.alert({
                                            ...
                                            theme: 'light',
                                            title: 'Failed!',
                                            content: 'Student has failed to add.'
                                        });
                                        console.log(result);
                                    }
                                }
