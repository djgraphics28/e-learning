...
<div class="form-group">
    <a href="{{ url('/admin/student') }}" class="btn btn-custom btn-outline-primary"><i class="fa fa-arrow-circle-left"></i> <b>BACK</b></a>
</div>
    ...
    $(document).ready(function() {
        $('#updateForm').on('submit', function(e) {
            ...
            $.confirm({
                ...
                theme: 'light',
                title: 'Update',
                content: 'This student will be updated, continue?',
                buttons: {
                    No: function () {
                    ...
                    Yes: {
                        ...
                        action: function(){
                            $.ajax({
                                url: '{{ url("admin/student/update/save") }}',
                                method: 'post',
                                data: fd,
                                processData:false,
                                contentType: false,
                                success: function(result){
                                    if (result  == 'success') {
                                        $.alert({
                                            ...
                                            theme: 'light',
                                            title: 'Success!',
                                            content: 'Student account has been updated.',
                                            buttons: {
                                                OK: function () {
                                        ...
                                        $.alert({
                                            ...
                                            theme: 'light',
                                            title: 'Failed!',
                                            content: 'Student account has failed to update.'
                                        });
                                        console.log(result);
                                    }
                                }
