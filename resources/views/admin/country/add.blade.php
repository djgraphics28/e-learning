...
<div class="form-group">
    <a href="{{ url('/admin/country') }}" class="btn btn-custom btn-outline-success"><i class="fa fa-arrow-circle-left"></i> <b>BACK</b></a>
</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="capital_name" required>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
            ...
            $.confirm({
                ...
                buttons: {
                    ...
                    Yes: {
                        ...
                        action: function(){
                            $.ajax({
                                url: '{{ url("admin/country/add/save") }}',
                                method: 'post',
                                data: fd,
                                processData:false,
                                contentType: false,
