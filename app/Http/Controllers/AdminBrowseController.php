...
class AdminBrowseController extends Controller
{
    ...
    public function table(Request $request) {
        ...
        if (Auth::user()->user_type == 1) {
            $data = DB::table('browses')
                ->selectRaw('id, image, country, title, context, created_at')
